...
<head>
	...
	<title>Blurb is Price Comparison, Product Review and Affiliate, Social Business, Multi vendor Store, HTML Template
	</title>
						...
						<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
							<div class="btn-group" role="group">
								...
								<div class="dropdown-menu wd-btn-country-list" aria-labelledby="btnGroupDrop3">
									<a class="dropdown-item" href="#"><img src="img/flag-icon-2.png" alt="flag-icon">
										Bangla</a>
									<a class="dropdown-item" href="#"><img src="img/flag-icon-3.png" alt="flag-icon">
										Spanish</a>
								</div>
							</div>
						</div>
										...
										<div class="col-md-12 p0">
											...
											<div class="modal-tab-section wd-modal-tabs">
												<ul class="nav nav-tabs wd-modal-tab-menu text-center" id="myTabs" role="tablist">
													...
													<li class="nav-item">
														<a class="nav-link" id="sign-up-tab" data-toggle="tab" href="#sign-up" role="tab" aria-controls="sign-up">Sign
															up</a>
													</li>
												</ul>
																	...
																	<div class="login-form text-left">
																		<form>
																			<div class="form-group">
																				<label for="exampleInputEmaillogin">User
																					name</label>
																			...
																			<div class="wd-policy">
																				<p>
																					By Continuing. I conferm that i have
																					read and userstand the <a href="#">terms of uses</a> and
																					<a href="#">Privacy Policy</a>.
																					Don’t have an account? <a href="#" class="black-color"><strong><u>Sign
																								up</u></strong></a>
																				</p>
																			</div>
																		</form>
																...
																<div class="sign-up-section text-center">
																	<div class="login-form text-left">
																		<form>
																			...
																			<button type="submit" class="btn btn-primary wd-login-btn">Sign
																				Up</button>
						...
						<div id="department-list" class="department-list">
							<ul class="list-group">
								...
								<li class="list-group-item"><a href="product-details-scroll.html">
										...
										</div><span class="sub-list-main-menu">Electronics</span>
									</a>
								</li>
								<li class="list-group-item"><a href="product-details-scroll.html">
										<div class="department-list-logo">
