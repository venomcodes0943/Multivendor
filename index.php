<?php
include_once("include/index-navbar.php")
?>
<!-- =========================
        Slider Section
    ============================== -->
<section id="main-slider-section">
	<div id="main-slider" class="slider-bg2  owl-carousel owl-theme product-review slider-cat">
		<div class="item d-flex  slider-bg align-items-center" style="background-image: url(img/slider-img/headphone.jpg);">
			<div class="container-fluid">
				<div class="row justify-content-end">
					...
					<div class="col-sm-6 col-md-6 col-xl-6 order-1 order-sm-2 slider-img">
						<img src="img/slider-img/watch.jpg" alt="" class="rounded">
					</div>
				</div>
			</div>
		</div>
		<div class="item d-flex  slider-bg align-items-center" style="background-image: url(img/slider-img/shoes-bg.jpg);">
			<div class="container-fluid">
				<div class="row justify-content-end">
					...
					<div class="col-sm-6 col-md-6 col-xl-6 mt-2 slider-img fadeInDown animated">
						<img src="img/slider-img/shoes.jpg" alt="" class="rounded">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-md-7 text-center">
				<div class=" wow fadeInUp animated" data-wow-delay="300ms">
					...
					<div class="description">
						<p>Pellentesque posuere orci lobortis scelerisque blandit. Donec id tellus lacinia an,
							tincidunt risus ac, consequat velit. Quisquemos sodales suscipit tortor ditaemcos
							condimentum lacus meleifend menean viverra auctor </p>
					</div>
							...
							<figcaption class="figure-caption">
								<div class="row">
									...
									<div class="col-md-12 p0 description">
										<p>Loret occaelit, sed quia non numquam eius modi tempora incidunt ut labore
								...
								<div class="row">
									<div class="col-md-6 p0 row">
										...
										<div class="col-8 col-md-8 p0">
											...
											<span class="sub-title">CEO at <a href="http://www.wditsolution.com/">WD
													IT SOLUTION</a></span>
										</div>
									</div>
									<div class="col-md-6 text-right client-rating">
				...
				<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="300ms">
					...
					<figcaption class="figure-caption">
						...
						<div class="blog-content">
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem ab ratione quibusdam,
							distinctio numquam. Eligendi recusandae qu.
						</div>
						<div class="raed-more">
	...
	<div class="container ">
		<div class="row ">
			<div class="col-12 col-md-6">
				<h2 class="call-to-action-message">The most happy <span class="bold-font">Comparison</span> theme to
					Build with great <span class="bold-font">Features.</span></h2>
			</div>
